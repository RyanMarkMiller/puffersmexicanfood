...
= 1.14.3 =
* Adds new filters: locations_single_location_html and locations_single_location_html_{$id}, for customizing the output for each location in the locations and single_location shortcodes.
* Now passes the location object to the locations_search_results_item_html filter, to allow deeper customization of the search results.

= 1.14.2 =
* Adds ability to control width of map in locations list
* Adds search results style option to store locator

= 1.14.1 =
* Compatible with WP 4.5

= 1.14 =
* Option to set slug for Single Locations.
* Adds Editor Widgets.
...
= 1.13.2 =
* Adds support for Categories to the import/export function.
...
* 1.14.3: New filters: locations_single_location_html and locations_single_location_html_{$id}. Update locations_search_results_item_html filter with extra data.
